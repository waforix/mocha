...
export type APIInteractionCallbackData<T = InteractionCallbackType> = T extends
...
export type InteractionCallbackData<T = InteractionCallbackType> = Library<
  APIInteractionCallbackData<T>
>;
