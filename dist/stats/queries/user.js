...
export class UserQueries {
    ...
    async getTop(guildId, type, limit = 10, days = 30) {
        ...
        return await this.db
            ...
            .where(and(eq(schema.voiceEvents.guildId, guildId), eq(schema.voiceEvents.action, 'leave'), gte(schema.voiceEvents.timestamp, since)))
